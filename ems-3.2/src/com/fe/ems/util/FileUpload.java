...
public class FileUpload extends HttpServlet {
	...
	private File tempPath = new File("..\\webapps\\ems-3.1\\images\\tmp\\"); // 用于存放临时文件的目录
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		factory.setRepository(new File("..\\webapps\\ems-3.1\\images\\temp"));
	...
	public void init() throws ServletException {
		...
		this.uploadPath = "..\\webapps\\ems-3.1\\images\\upload_images\\";
		//System.out.println("uploadPath："+uploadPath);
		/*
		File directory = new File("");//设定为当前文件夹
		try {
			System.out.println("上传图片的当前路径："+directory.getCanonicalPath());
		} catch (IOException e) {
