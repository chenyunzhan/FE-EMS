...
msgObj.style.cssText = "position:absolute;font:11px '宋体';top:"+(iHeight-h + 130)/2+"px;left:"+(iWidth-w+ 120) /2+"px;width:"+w+"px;height:"+h+"px;text-align:center;border:1px solid "+bordercolor+";background-color:"+bgcolor+";padding:1px;line-height:22px;z-index:102;";
