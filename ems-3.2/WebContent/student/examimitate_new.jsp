...
<%
	String p_id = this.getServletContext().getInitParameter("moniexamname");
	examtime.setP_id(p_id);
%>

<%
	if(!examtime.getUserProtectMess(Login.getId(),examtime.getP_id(),1)){
		examtime.addUserProtectMess(Login.getId(),p_id,Integer.parseInt(this.getServletContext().getInitParameter("time")),"#",0,1);
	}
	else{
		examtime.setP_id(examtime.getP_id(Login.getId(),1));
	}
...
<script src="../js/jquery.min.js" type="text/javascript" language="JavaScript"></script>
        ...
        <script language="javascript" type="text/javascript">
                ...
                var index = 1;//当前第几题
                 <%  
	                 if(examtime.getUserProtectMess(Login.getId(),examtime.getP_id(),1) && !examtime.getAnswer(Login.getId(),examtime.getP_id()).equals("#")){
				...
				$(function(){
                   ...
                   function fankui()
                    ...
                    {   
                        ...
                        obj.src = "../images/upload_images/" + "<%=examtime.getP_id(Login.getId(),1) %>" + timuId[index-1] + ".jpg";
