...
Random random = new Random();
	int i = random.nextInt(10)+1;//产生一个随机数 范围在1-10之间
	...
	//在此处设置模拟考试的试卷ID
	//examtime.setP_id(this.getServletContext().getInitParameter("monitimuid"));
%>
...
<div id="wrapper">
  ...
  <div id="header">
    <div id="menu">
      <ul>
        <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="index.jsp" class="first">正式考试</a></li>
         <% if(Login.isSuccess()){
			%>
...
//                        } 
                   ...
                   function zuoda(v)
                   {
                       ...
                       fdatiqingkuang(v);//答题情况            
                        ...
                        if(index == total)
                        {
                            ...
                            //.fadeIn(1000);
                            //var objWH=getObjWh('mydiv');
                            //var tbT=objWH.split("|")[0]/4+"px";
                            //var tbL=objWH.split("|")[1]/4+"px";
                            
                            //var tp = document.body.clientWidth/10;//网页正文部分宽
                            //var lt = document.body.clientHeight/10;
                            
                            //var st = window.screen.height;//屏幕分辨率的高
                            //var sl = window.screen.width;
                            
                            //var vt = window.screen.availHeight;//屏幕可用工作区高度
                            //var vl = window.screen.availWidth;
                            
                            //$("#mydiv").css({"top":tp,"left":lt,"z-index":"9999","display":"block"})
                  ...
                  function fdatiqingkuang(v)
                   {
                	   var uri = "../server/daanlianxi.jsp?id=" + timuId[index-1] + "&answer=" +v + "&miaozhong=" + miaozhong + "&yhdaan=" + yhdaan;
                       if(window.XMLHttpRequest){
							req = new XMLHttpRequest();
                       }else if (window.ActiveXObject){
							req = new ActiveXObject("Microsoft.XMLHTTP");
