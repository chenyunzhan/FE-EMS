  ...
  <br /><br /><br />
	<div class="exam_main" style="margin-left:auto; margin-right:auto;">
	  <div class="exam_left">
	   ...
	   <img id="studentPhoto" border="1" height="147" width="120" style="border-color:#000000" src="../images/upload_images/111 %>.jpg" alt="" />
	    </div>
	    
        <div class="exam_username STYLE1">用户名<br />
        <span class="STYLE3">临时用户</span></div>
		<div class="exam_userNo STYLE1">考试号<br />
	    <span class="STYLE3">001</span></div>
				...
				$(function(){
                   ...
                   function fankui()
                    ...
                    {   
                        ...
                        obj.src = "../images/upload_images/" + "<%=p_id%>" + timuId[index-1] + ".jpg";
